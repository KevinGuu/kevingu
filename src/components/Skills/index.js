        ...
        <Grid container spacing={2}>
            ...
            <Card sx={{ maxWidth: 355 }}>
              ...
              <CardContent>
                ...
                <Typography variant="body1">
                  {" "}
                  - Docker | Kubernetes | Jenkins | Azure DevOps
                </Typography>
          ...
          <Grid item md={4} sx={{ display: "flex" }}>
            <Card sx={{ maxWidth: 355 }}>
              ...
              <CardContent>
                <Typography variant="body1" sx={{ pb: 1 }}>
                  Familiar with the following business analytics & data
                  analytics tools.
                </Typography>
          ...
          <Grid item md={4} sx={{ display: "flex" }}>
            <Card sx={{ maxWidth: 355 }}>
              ...
              <CardContent>
                <Typography variant="body1" sx={{ pb: 1 }}>
                  Certified Scaled Agile Framework (SAFe) practicioner well
                  versed in software development methodologies and best
                  practices.
                </Typography>
          ...
          <Grid item md={4} sx={{ display: "flex" }}>
            <Card sx={{ maxWidth: 355 }}>
              ...
              <CardContent>
                <Typography variant="body1" sx={{ pb: 1 }}>
                  Lover of language fluent in two languages and actively
                  learning two more!
                </Typography>
                <Typography variant="body1">
